...
<<>>=
# tm= tama\~no de la muestra

tm=100; n <- 10; p <- 0.25

# generando las 100 n\'umeros aleatorios
...
hist(Z, main="Histograma de Z ~ N(0, 1)", 
     xlab="z = número binomiales estándarizados", 
...
xlab="Valores de m medias normales estándarizadas", 
...
hist(MediasEstand, main="Medias Exp(10); n=1", 
     xlab="m medias exp estándarizadas", 
prob=TRUE, col="darkolivegreen3") 
